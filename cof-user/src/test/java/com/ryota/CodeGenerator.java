...
import com.ryota.cofuser.CofUserApplication;
import org.junit.Test;
import org.springframework.boot.test.context.SpringBootTest;

@SpringBootTest(classes = CofUserApplication.class)
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("D:\\idea_workspace\\haruCloud\\cof-user\\src\\main\\java");
        // 生成注释时的作者
        gc.setAuthor("ryota");
        //生成后是否打开资源管理器
        gc.setOpen(false);
...
//        dsc.setUrl("jdbc:mysql://10.71.177.82:3306/cnooc-cy?serverTimezone=Asia/Shanghai");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/auth-center?serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.ryota.cofuser");
